            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="flex justify-center pt-8">
                <button
                  ...
                  disabled={isPending}
                  className="flex justify-center gap-4 items-center mx-auto shadow-xl text-lg bg-background backdrop-blur-md font-bold isolation-auto border-foreground/10 before:absolute before:w-full before:transition-transform before:duration-700 before:ease-in-out before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-foreground hover:text-background before:-z-10 before:aspect-square before:hover:scale-[2.5] relative z-10 px-8 py-4 overflow-hidden border-2 rounded-full group disabled:opacity-50 disabled:cursor-not-allowed transition-all transform-gpu"
                >
                  {isPending ? "Processing..." : "Analyze Meeting"}
                  <svg
                    className="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-background text-background transition-all duration-700 ease-in-out rounded-full border border-foreground group-hover:border-none p-2 rotate-45 transform-gpu"
                    viewBox="0 0 16 19"
