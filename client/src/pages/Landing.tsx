            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="flex justify-center pt-8">
                <Button
                  ...
                  disabled={isPending}
                  size="lg"
                  className="h-14 px-10 rounded-full text-lg font-bold shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] group relative overflow-hidden"
                >
                  <span className="relative z-10 flex items-center gap-3">
                    {isPending ? "Processing..." : "Analyze Meeting"}
                    {!isPending && (
                      <div className="p-1 rounded-full bg-background/20 group-hover:bg-background/30 transition-colors">
