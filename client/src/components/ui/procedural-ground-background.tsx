  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Color Palette - Using Site Primary Blue (#01497b)
        vec3 baseColor = vec3(0.98, 0.98, 0.96);    // Light Beige Background
        vec3 lineColor = vec3(0.004, 0.286, 0.482); // Primary Blue (#01497b) - Navbar color
        
        // Composite - Simple mix for clean lines
        vec3 finalColor = baseColor;
        finalColor = mix(finalColor, lineColor, topoLine * depth * 0.8);
        
        // Subtle horizon fade
        float fade = smoothstep(0.2, -0.8, uv.y);
        finalColor = mix(finalColor, baseColor, fade * 0.6);
